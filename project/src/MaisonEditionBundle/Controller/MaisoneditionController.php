...
class MaisoneditionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('@MaisonEdition\Default\index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('@MaisonEdition\Default\new.html.twig', array(
    ...
    public function showAction(Maisonedition $maisonedition)
    {
        ...
        return $this->render('@MaisonEdition\Default\show.html.twig', array(
            'maisonedition' => $maisonedition,
    ...
    public function editAction(Request $request, Maisonedition $maisonedition)
    {
        ...
        return $this->render('@MaisonEdition\Default\edit.html.twig', array(
            'maisonedition' => $maisonedition,
    ...
    public function supprimerAction($id){
        ...
        $maisonedition = $this->getDoctrine()
            ->getRepository(Maisonedition::class)
            ->find($id);

        $entityManager->remove($maisonedition);
        $entityManager->flush();
        $maisoneditions = $entityManager->getRepository('MaisonEditionBundle:Maisonedition')->findAll();
