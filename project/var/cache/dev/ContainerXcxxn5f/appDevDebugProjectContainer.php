...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'jjalvarezl_pdfjs_viewer.viewer_controller' => 'getJjalvarezlPdfjsViewer_ViewerControllerService.php',
            ...
            'nomaya.socialBarHelper' => 'getNomaya_SocialBarHelperService.php',
            'nomaya.socialLinksHelper' => 'getNomaya_SocialLinksHelperService.php',
        ...
        $this->privates = array(
            ...
            'jjalvarezl_pdfjs_viewer.viewer_controller' => true,
            ...
            'nomaya.socialBarHelper' => true,
            'nomaya.socialLinksHelper' => true,
            ...
            'twig.extension.nomaya_social_bar' => true,
            'twig.extension.nomaya_social_links' => true,
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'\\vendor\\ob\\highcharts-bundle\\Twig\\HighchartsExtension.php';
            ...
            include_once $this->targetDirs[3].'\\vendor\\nomaya\\social-bundle\\Nomaya\\SocialBundle\\Twig\\Extension\\NomayaTwigSocialBar.php';
            include_once $this->targetDirs[3].'\\vendor\\nomaya\\social-bundle\\Nomaya\\SocialBundle\\Twig\\Extension\\NomayaTwigSocialLinks.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('MPk0jGPBdV', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4SCJXOBikR', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(${($_ = isset($this->services['twig.extension.nomaya_social_bar']) ? $this->services['twig.extension.nomaya_social_bar'] : $this->getTwig_Extension_NomayaSocialBarService()) && false ?: '_'});
        $instance->addExtension(${($_ = isset($this->services['twig.extension.nomaya_social_links']) ? $this->services['twig.extension.nomaya_social_links'] : $this->services['twig.extension.nomaya_social_links'] = new \Nomaya\SocialBundle\Twig\Extension\NomayaTwigSocialLinks($this)) && false ?: '_'});
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('k0yMkcx74X', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2L8YdaoR9S', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kN+MyX3-wO', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    /**
     * Gets the private 'twig.extension.nomaya_social_bar' shared service.
     *
    ...
    /**
     * Gets the private 'twig.extension.nomaya_social_links' shared service.
     *
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'\\src\\PanierBundle/Resources/views'), 'Panier');
        $instance->addPath(($this->targetDirs[3].'\\src\\PanierBundle/Resources/views'), '!Panier');
        $instance->addPath(($this->targetDirs[3].'\\src\\AccueilBundle/Resources/views'), 'Accueil');
        $instance->addPath(($this->targetDirs[3].'\\src\\AccueilBundle/Resources/views'), '!Accueil');
        $instance->addPath(($this->targetDirs[3].'\\src\\EvenementBundle/Resources/views'), 'Evenement');
        $instance->addPath(($this->targetDirs[3].'\\src\\EvenementBundle/Resources/views'), '!Evenement');
        $instance->addPath(($this->targetDirs[3].'\\src\\EchangeBundle/Resources/views'), 'Echange');
        $instance->addPath(($this->targetDirs[3].'\\src\\EchangeBundle/Resources/views'), '!Echange');
        $instance->addPath(($this->targetDirs[3].'\\src\\ContactBundle/Resources/views'), 'Contact');
        $instance->addPath(($this->targetDirs[3].'\\src\\ContactBundle/Resources/views'), '!Contact');
        $instance->addPath(($this->targetDirs[3].'\\src\\LocauxBundle/Resources/views'), 'Locaux');
        $instance->addPath(($this->targetDirs[3].'\\src\\LocauxBundle/Resources/views'), '!Locaux');
        $instance->addPath(($this->targetDirs[3].'\\src\\EmpruntBundle/Resources/views'), 'Emprunt');
        $instance->addPath(($this->targetDirs[3].'\\src\\EmpruntBundle/Resources/views'), '!Emprunt');
        $instance->addPath(($this->targetDirs[3].'\\src\\PromotionsBundle/Resources/views'), 'Promotions');
        $instance->addPath(($this->targetDirs[3].'\\src\\PromotionsBundle/Resources/views'), '!Promotions');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ForumBundle/Resources/views'), '!Forum');
        $instance->addPath(($this->targetDirs[3].'\\src\\MaisonEditionBundle/Resources/views'), 'MaisonEdition');
        $instance->addPath(($this->targetDirs[3].'\\src\\MaisonEditionBundle/Resources/views'), '!MaisonEdition');
        $instance->addPath(($this->targetDirs[3].'\\src\\LivreBundle/Resources/views'), 'Livre');
        $instance->addPath(($this->targetDirs[3].'\\src\\LivreBundle/Resources/views'), '!Livre');
        $instance->addPath(($this->targetDirs[3].'\\src\\AdminBundle/Resources/views'), 'Admin');
        $instance->addPath(($this->targetDirs[3].'\\src\\AdminBundle/Resources/views'), '!Admin');
        $instance->addPath(($this->targetDirs[3].'\\src\\AchatBundle/Resources/views'), 'Achat');
        $instance->addPath(($this->targetDirs[3].'\\src\\AchatBundle/Resources/views'), '!Achat');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\jjalvarezl\\pdfjs-viewer-bundle\\jjalvarezl\\PDFjsViewerBundle/Resources/views'), 'jjalvarezlPDFjsViewer');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\jjalvarezl\\pdfjs-viewer-bundle\\jjalvarezl\\PDFjsViewerBundle/Resources/views'), '!jjalvarezlPDFjsViewer');
        $instance->addPath(($this->targetDirs[3].'\\src\\ParticipantBundle/Resources/views'), 'Participant');
        $instance->addPath(($this->targetDirs[3].'\\src\\ParticipantBundle/Resources/views'), '!Participant');
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\nomaya\\social-bundle\\Nomaya\\SocialBundle/Resources/views'), '!NomayaSocial');
        $instance->addPath(($this->targetDirs[3].'\\src\\MlkStatBundle/Resources/views'), 'MlkStat');
        $instance->addPath(($this->targetDirs[3].'\\src\\MlkStatBundle/Resources/views'), '!MlkStat');
        $instance->addPath(($this->targetDirs[3].'\\src\\AuteurBundle/Resources/views'), 'Auteur');
        $instance->addPath(($this->targetDirs[3].'\\src\\AuteurBundle/Resources/views'), '!Auteur');
        $instance->addPath(($this->targetDirs[3].'\\src\\AdminForumBundle/Resources/views'), 'AdminForum');
        $instance->addPath(($this->targetDirs[3].'\\src\\AdminForumBundle/Resources/views'), '!AdminForum');
        $instance->addPath(($this->targetDirs[3].'\\src\\ForumMobilBundle/Resources/views'), 'ForumMobil');
        $instance->addPath(($this->targetDirs[3].'\\src\\ForumMobilBundle/Resources/views'), '!ForumMobil');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'PanierBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PanierBundle'),
                    'namespace' => 'PanierBundle',
                ),
                'AccueilBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AccueilBundle'),
                    'namespace' => 'AccueilBundle',
                ),
                'EvenementBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\EvenementBundle'),
                    'namespace' => 'EvenementBundle',
                ),
                'EchangeBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\EchangeBundle'),
                    'namespace' => 'EchangeBundle',
                ),
                'ContactBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ContactBundle'),
                    'namespace' => 'ContactBundle',
                ),
                'LocauxBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\LocauxBundle'),
                    'namespace' => 'LocauxBundle',
                ),
                'EmpruntBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\EmpruntBundle'),
                    'namespace' => 'EmpruntBundle',
                ),
                'PromotionsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PromotionsBundle'),
                    'namespace' => 'PromotionsBundle',
                ),
                'userBundle' => array(
                    'parent' => NULL,
                ...
                'MaisonEditionBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MaisonEditionBundle'),
                    'namespace' => 'MaisonEditionBundle',
                ),
                'LivreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\LivreBundle'),
                ...
                'AchatBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AchatBundle'),
                    'namespace' => 'AchatBundle',
                ),
                'jjalvarezlPDFjsViewerBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\vendor\\jjalvarezl\\pdfjs-viewer-bundle\\jjalvarezl\\PDFjsViewerBundle'),
                ...
                'ParticipantBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ParticipantBundle'),
                ...
                'KnpSnappyBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:/wamp64/www/project/vendor/knplabs/knp-snappy-bundle',
                    'namespace' => 'Knp\\Bundle\\SnappyBundle',
                ),
                'MlkStatBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MlkStatBundle'),
                    'namespace' => 'MlkStatBundle',
                ),
                'AuteurBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AuteurBundle'),
                    'namespace' => 'AuteurBundle',
                ),
                'AdminForumBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AdminForumBundle'),
                    'namespace' => 'AdminForumBundle',
                ),
                ...
                'ForumMobilBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ForumMobilBundle'),
                    'namespace' => 'ForumMobilBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            case 'upload_directory': $value = ($this->targetDirs[3].'/taswira'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PanierBundle' => 'PanierBundle\\PanierBundle',
                'AccueilBundle' => 'AccueilBundle\\AccueilBundle',
                'EvenementBundle' => 'EvenementBundle\\EvenementBundle',
                'EchangeBundle' => 'EchangeBundle\\EchangeBundle',
                'ContactBundle' => 'ContactBundle\\ContactBundle',
                'LocauxBundle' => 'LocauxBundle\\LocauxBundle',
                'EmpruntBundle' => 'EmpruntBundle\\EmpruntBundle',
                'PromotionsBundle' => 'PromotionsBundle\\PromotionsBundle',
                'userBundle' => 'userBundle\\userBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'ForumBundle' => 'ForumBundle\\ForumBundle',
                'MaisonEditionBundle' => 'MaisonEditionBundle\\MaisonEditionBundle',
                'LivreBundle' => 'LivreBundle\\LivreBundle',
                'AdminBundle' => 'AdminBundle\\AdminBundle',
                'AchatBundle' => 'AchatBundle\\AchatBundle',
                'jjalvarezlPDFjsViewerBundle' => 'jjalvarezl\\PDFjsViewerBundle\\jjalvarezlPDFjsViewerBundle',
                'ObHighchartsBundle' => 'Ob\\HighchartsBundle\\ObHighchartsBundle',
                'ParticipantBundle' => 'ParticipantBundle\\ParticipantBundle',
                ...
                'MlkStatBundle' => 'MlkStatBundle\\MlkStatBundle',
                'AuteurBundle' => 'AuteurBundle\\AuteurBundle',
                'AdminForumBundle' => 'AdminForumBundle\\AdminForumBundle',
                'CMENGoogleChartsBundle' => 'CMEN\\GoogleChartsBundle\\CMENGoogleChartsBundle',
                'ForumMobilBundle' => 'ForumMobilBundle\\ForumMobilBundle',
            ...
            'mailer_host' => 'seifeddine.dabbebi@esprit.tn',
            'mailer_user' => 'dabbebisifose@gmail.com',
            'mailer_password' => 'ss21101994ss',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'dabbebisifose@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'ss21101994ss',
            ...
            'fos_user.model.group.class' => 'userBundle\\Entity\\Group',
