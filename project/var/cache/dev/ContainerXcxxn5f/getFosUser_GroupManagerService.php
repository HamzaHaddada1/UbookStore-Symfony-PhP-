...
return $this->services['fos_user.group_manager'] = new \FOS\UserBundle\Doctrine\GroupManager(${($_ = isset($this->services['fos_user.object_manager']) ? $this->services['fos_user.object_manager'] : $this->load('getFosUser_ObjectManagerService.php')) && false ?: '_'}, 'userBundle\\Entity\\Group');
