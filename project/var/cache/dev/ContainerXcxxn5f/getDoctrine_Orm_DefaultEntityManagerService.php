...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\PanierBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\EvenementBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\EchangeBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\LocauxBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\EmpruntBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\userBundle\\Entity'), 6 => ($this->targetDirs[3].'\\src\\MaisonEditionBundle\\Entity'), 7 => ($this->targetDirs[3].'\\src\\LivreBundle\\Entity'), 8 => ($this->targetDirs[3].'\\src\\AchatBundle\\Entity'), 9 => ($this->targetDirs[3].'\\src\\ParticipantBundle\\Entity'), 10 => ($this->targetDirs[3].'\\src\\MlkStatBundle\\Entity'), 11 => ($this->targetDirs[3].'\\src\\AuteurBundle\\Entity'), 12 => ($this->targetDirs[3].'\\src\\AdminForumBundle\\Entity'), 13 => ($this->targetDirs[3].'\\src\\ForumMobilBundle\\Entity')));

$b->addDriver($c, 'PanierBundle\\Entity');
$b->addDriver($c, 'EvenementBundle\\Entity');
$b->addDriver($c, 'EchangeBundle\\Entity');
$b->addDriver($c, 'LocauxBundle\\Entity');
$b->addDriver($c, 'EmpruntBundle\\Entity');
$b->addDriver($c, 'userBundle\\Entity');
$b->addDriver($c, 'MaisonEditionBundle\\Entity');
$b->addDriver($c, 'LivreBundle\\Entity');
$b->addDriver($c, 'AchatBundle\\Entity');
$b->addDriver($c, 'ParticipantBundle\\Entity');
$b->addDriver($c, 'MlkStatBundle\\Entity');
$b->addDriver($c, 'AuteurBundle\\Entity');
$b->addDriver($c, 'AdminForumBundle\\Entity');
$b->addDriver($c, 'ForumMobilBundle\\Entity');
...
$a->setEntityNamespaces(array('PanierBundle' => 'PanierBundle\\Entity', 'EvenementBundle' => 'EvenementBundle\\Entity', 'EchangeBundle' => 'EchangeBundle\\Entity', 'LocauxBundle' => 'LocauxBundle\\Entity', 'EmpruntBundle' => 'EmpruntBundle\\Entity', 'userBundle' => 'userBundle\\Entity', 'MaisonEditionBundle' => 'MaisonEditionBundle\\Entity', 'LivreBundle' => 'LivreBundle\\Entity', 'AchatBundle' => 'AchatBundle\\Entity', 'ParticipantBundle' => 'ParticipantBundle\\Entity', 'MlkStatBundle' => 'MlkStatBundle\\Entity', 'AuteurBundle' => 'AuteurBundle\\Entity', 'AdminForumBundle' => 'AdminForumBundle\\Entity', 'ForumMobilBundle' => 'ForumMobilBundle\\Entity'));
