 ...
 */
class Event extends \EvenementBundle\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EvenementBundle\\Entity\\Event' . "\0" . 'id', '' . "\0" . 'EvenementBundle\\Entity\\Event' . "\0" . 'nom', '' . "\0" . 'EvenementBundle\\Entity\\Event' . "\0" . 'lieu', '' . "\0" . 'EvenementBundle\\Entity\\Event' . "\0" . 'date', '' . "\0" . 'EvenementBundle\\Entity\\Event' . "\0" . 'heure', '' . "\0" . 'EvenementBundle\\Entity\\Event' . "\0" . 'description', '' . "\0" . 'EvenementBundle\\Entity\\Event' . "\0" . 'capacite', '' . "\0" . 'EvenementBundle\\Entity\\Event' . "\0" . 'nbreParticipant', '' . "\0" . 'EvenementBundle\\Entity\\Event' . "\0" . 'img'];
        }
    ...
    public function getNbreParticipant()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNbreParticipant', []);

        return parent::getNbreParticipant();
    }
    ...
    public function setNbreParticipant($nbreParticipant)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbreParticipant', [$nbreParticipant]);

        return parent::setNbreParticipant($nbreParticipant);
    }
