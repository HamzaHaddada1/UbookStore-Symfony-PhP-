 ...
 */
class promo extends \LivreBundle\Entity\promo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LivreBundle\\Entity\\promo' . "\0" . 'id', '' . "\0" . 'LivreBundle\\Entity\\promo' . "\0" . 'valeur'];
        }
