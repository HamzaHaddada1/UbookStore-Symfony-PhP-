...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\PanierBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\userBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\LivreBundle\\Entity')));
...
$a->setEntityNamespaces(array('PanierBundle' => 'PanierBundle\\Entity', 'userBundle' => 'userBundle\\Entity', 'LivreBundle' => 'LivreBundle\\Entity'));
