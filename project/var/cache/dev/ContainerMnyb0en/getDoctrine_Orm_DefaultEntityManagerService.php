...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\PanierBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\EvenementBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\EchangeBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\LocauxBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\EmpruntBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\userBundle\\Entity'), 6 => ($this->targetDirs[3].'\\src\\MaisonEditionBundle\\Entity'), 7 => ($this->targetDirs[3].'\\src\\LivreBundle\\Entity'), 8 => ($this->targetDirs[3].'\\src\\AchatBundle\\Entity'), 9 => ($this->targetDirs[3].'\\src\\ParticipantBundle\\Entity'), 10 => ($this->targetDirs[3].'\\src\\MlkStatBundle\\Entity'), 11 => ($this->targetDirs[3].'\\src\\AuteurBundle\\Entity'), 12 => ($this->targetDirs[3].'\\src\\AdminForumBundle\\Entity')));
