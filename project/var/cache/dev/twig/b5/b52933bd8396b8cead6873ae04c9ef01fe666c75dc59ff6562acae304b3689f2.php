...
class __TwigTemplate_a467f96ca8d26f8ec8b506c8d942e8f38a3c485fa192df9d256d78a0106abffa extends Twig_Template
{
...
";
        ...
        if ((($context["position"] ?? $this->getContext($context, "position")) != "left")) {
            $context["classes"] = twig_array_merge(($context["classes"] ?? $this->getContext($context, "classes")), array(0 => ("is-" . ($context["position"] ?? $this->getContext($context, "position")))));
        }
        // line 10
        if (($context["rounded"] ?? $this->getContext($context, "rounded"))) {
            $context["classes"] = twig_array_merge(($context["classes"] ?? $this->getContext($context, "classes")), array(0 => "is-rounded"));
        }
        // line 11
        if ((($context["size"] ?? $this->getContext($context, "size")) != null)) {
            $context["classes"] = twig_array_merge(($context["classes"] ?? $this->getContext($context, "classes")), array(0 => ("is-" . ($context["size"] ?? $this->getContext($context, "size")))));
        }
        // line 12
        echo "
";
...
{% endif %}
", "KnpPaginatorBundle:Pagination:bulma_pagination.html.twig", "C:\\wamp64\\www\\project\\vendor\\knplabs\\knp-paginator-bundle/Resources/views/Pagination/bulma_pagination.html.twig");
    }
}
