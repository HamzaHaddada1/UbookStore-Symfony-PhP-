...
/* baseAdmin.html.twig */
class __TwigTemplate_a0f1fa074eab055bc37daa2d97c15ac94e51f91b5490de34d18406c49e7bf660 extends Twig_Template
{
...
";
    ...
    <div class=\"d-flex\">
        ...
        echo "\"><img src=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl("icons/addAuteur.png"), "html", null, true);
        echo "\" alt=\"logo\" width=\"20px\" height=\"20px\">  Ajouter Evenement</a></li>
                        <li><a href=\"";
        // line 128
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("event_index");
        echo "\"><img src=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl("icons/delete.png"), "html", null, true);
        echo "\" alt=\"logo\" width=\"20px\" height=\"20px\">Liste des evenements</a></li>
                ...
                <li><a href=\"";
        // line 134
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("comments1_index");
        echo "\"><img src=\"";
        ...
        echo "\"><img src=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl("icons/delete.png"), "html", null, true);
        echo "\" alt=\"logo\" width=\"20px\" height=\"20px\">Liste Maison Edition</a></li>
        ...
        echo "\" data-toggle=\"collapse\"><img src=\"";
        ...
        echo "\"><img src=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl("icons/addAuteur.png"), "html", null, true);
        echo "\" alt=\"logo\" width=\"20px\" height=\"20px\">  Ajouter Echange</a></li>
                        <li><a href=\"";
        // line 170
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("echange_index");
        echo "\"><img src=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl("icons/maison.png"), "html", null, true);
        echo "\" alt=\"logo\" width=\"20px\" height=\"20px\">Liste Echange</a></li>
        ...
        echo "\"><img src=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl("icons/addAuteur.png"), "html", null, true);
        echo "\" alt=\"logo\" width=\"20px\" height=\"20px\">  Ajouter local</a></li>
                        <li><a href=\"";
        // line 182
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("locaux_index");
        echo "\"><img src=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl("icons/maison.png"), "html", null, true);
        echo "\" alt=\"logo\" width=\"20px\" height=\"20px\">Afficher locaux</a></li>
...
";
    ...
    {
        return array (  474 => 213,  457 => 207,  444 => 208,  442 => 207,  429 => 199,  418 => 193,  408 => 188,  397 => 182,  391 => 181,  384 => 177,  372 => 170,  366 => 169,  359 => 165,  347 => 158,  342 => 156,  330 => 149,  318 => 142,  312 => 141,  305 => 137,  297 => 134,  286 => 128,  280 => 127,  273 => 123,  263 => 116,  259 => 115,  252 => 111,  234 => 96,  224 => 89,  219 => 86,  210 => 85,  138 => 20,  134 => 19,  130 => 18,  126 => 17,  122 => 16,  118 => 15,  112 => 12,  108 => 11,  104 => 10,  100 => 9,  96 => 8,  93 => 7,  84 => 6,  66 => 5,  54 => 215,  52 => 213,  49 => 212,  47 => 85,  42 => 82,  40 => 6,  36 => 5,  30 => 1,);
    }
        ...
        <div class=\"sidebar sidebar-dark bg-dark\">
            <ul class=\"list-unstyled\">
                ...
                <li>
                    ...
                    <ul id=\"sm_evenement\" class=\"list-unstyled collapse\">
                        <li><a href=\"{{ path('event_ajout') }}\"><img src=\"{{ asset('icons/addAuteur.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\">  Ajouter Evenement</a></li>
                        <li><a href=\"{{ path('event_index') }}\"><img src=\"{{ asset('icons/delete.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\">Liste des evenements</a></li>


                    </ul>
                </li>

                <li><a href=\"{{ path('comments1_index') }}\"><img src=\"{{ asset('icons/forum.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\"> Gestion Forum</a></li>
                ...
                <li>
                    ...
                    <ul id=\"sm_maison\" class=\"list-unstyled collapse\">
                        <li><a href=\"{{ path('maisonedition_new') }}\"><img src=\"{{ asset('icons/addAuteur.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\">Ajouter Maison Edition</a></li>
                        <li><a href=\"{{ path('maisonedition_index') }}\"><img src=\"{{ asset('icons/delete.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\">Liste Maison Edition</a></li>
                ...
                <li>
                    <a href=\"{{ path('reclamation_index') }}\" ><img src=\"{{ asset('icons/recla.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\">
                        Reclamation
                    </a>
                ...
                <li>
                    <a href=\"{{ path('livres_index') }}\" data-toggle=\"collapse\"><img src=\"{{ asset('icons/books.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\">
                        Gestion Des Livres
                    </a>
                ...
                <li>
                    ...
                    <ul id=\"sm_echange\" class=\"list-unstyled collapse\">
                        <li><a href=\"{{ path('echange_new') }}\"><img src=\"{{ asset('icons/addAuteur.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\">  Ajouter Echange</a></li>
                        <li><a href=\"{{ path('echange_index') }}\"><img src=\"{{ asset('icons/maison.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\">Liste Echange</a></li>
                ...
                <li>
                    ...
                    <ul id=\"sm_locaux\" class=\"list-unstyled collapse\">
                        <li><a href=\"{{ path('locaux_new') }}\"><img src=\"{{ asset('icons/addAuteur.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\">  Ajouter local</a></li>
                        <li><a href=\"{{ path('locaux_index') }}\"><img src=\"{{ asset('icons/maison.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\">Afficher locaux</a></li>


                    </ul>
                </li>
                <li>
                    <a href=\"{{ path(\"auteur_index\") }}\" ><img src=\"{{ asset('icons/author.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\">
                        Gestion Des Auteurs
                    </a>
                </li>
                <li>
                    <a href=\"{{ path('emprunt_index') }}\" ><img src=\"{{ asset('icons/emprunt.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\">
                        Gestion Des Emprunts
                    </a>

                </li>
                <li>
                    <a href=\"{{ path(\"comments_index\") }}\" ><img src=\"{{ asset('icons/author.png') }}\" alt=\"logo\" width=\"20px\" height=\"20px\">
                        Gestion Des Commentaires
                    </a>
                </li>
            </ul>
